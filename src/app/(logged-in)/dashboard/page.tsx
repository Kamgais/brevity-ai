    ...
    <div className="container mx-auto flex flex-col gap-4">
      <div className="px-2 py-12 sm:py-24">
        ...
        <p className="text-gray-600">Transform your PDF's into concise, actionable insights</p>
          ...
          <Button variant={'link'} className="bg-linear-to-r from-rose-500 to-rose-700 hover:from-rose-600 hover:to-rose-800 hover:scale-105 transition-all duration-300 hover:no-underline" disabled={hasReachedLimit}>
