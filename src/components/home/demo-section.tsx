...
export default function DemoSection() {
  return (
   <section className='relative'>
    <div className='py-12 lg:py-24 max-5-xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12'>
...
>
  <div
    ...
    style={{
      clipPath:
        'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 32.2% 48.5%, 68.1% 47.5%, 58.3% 35.4%, 45.2% 34.5%, 27.5% 76.7%, 10.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
    }}
  />
    </div>
