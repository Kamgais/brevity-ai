...
const steps: Step[] = [
    {
        ...
        description: 'Simply drap and drop your PDF document or click to upload'
    },
    {
...
>
  ...
  />
    ...
    <div className="text-center mb-16">
            ...
            <h3 className="font-bold text-3xl max-w-2xl mx-auto relative">Transform any PDF into easy-to-digest summary in three simple steps</h3>
        </div>
