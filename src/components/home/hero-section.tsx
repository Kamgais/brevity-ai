...
export default function HeroSection() {
  return (
   ...
   items-center justify-center py-16 sm:py-20 
   ...
   >
        ...
        Transform PDFs into {' '}
          ...
          <span className="absolute inset-0 bg-rose-200/50 rounded-lg transform -skew-y-1" aria-hidden='true'>
          </span>
        ...
        <h2 className="text-lg sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600">
          Get a beautiful summary reel of the document in seconds.
            ...
            <Button variant={'link'}  className="text-white mt-6 text-base sm:text-lg  
            lg:text-xl rounded-full px-8 sm:px-10 
            lg:px-12 py-6 sm:py-7 lg:py-8 lg:mt-16
